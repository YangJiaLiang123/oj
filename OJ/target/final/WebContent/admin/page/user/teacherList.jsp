...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		...
		<div class="layui-inline">
			<a class="layui-btn layui-btn-normal teacherAdd_btn">添加教师</a>  <!-- allUser.js中设置 -->
		</div>
		<div class="layui-inline">
			<form  action="deleteAllTeacher.do" >
	  	...
	  	<table class="layui-table">
		    ...
		    <tbody>
		    	...
		    	<tr>
		    		...
		    		<td>无</td>
		    		<td>无</td>
		    		<td><a class="layui-btn layui-btn-mini" href="changeTeacherInfo.do?id=${studnet.id }">
		    				<i class="iconfont icon-edit"></i>  修改
		    			</a>
		    			<a class="layui-btn layui-btn-danger layui-btn-mini users_del" href="deleteTeacher.do?id=${studnet.id }">
	...
	<script type="text/javascript" src="addTeacher.js"></script>
    ...
    var shref="teacherList.do?currentPage="+turnPage;
