...
<!-- 1.需要修改div的name、ajax
	...
	<div style="font-size: 25px;margin: 30px 0 20px -10%;text-align: center;">添加比赛题目</div>
		...
		<div>
			<p class="admin-regist-lable">作者</p>
			<input class="input-style" name="studentname" value="${student.studentname }" id="userName" type="text" placeholder="作者" >
			<!-- 提示信息 --><span  id="tishi" type="text" placeholder="提示信息"></span>
		</div>
		<!-- 时间 -->
		...
		<div class="fieldset">
			<button id="login-btn" type="submit" class="admin-regist-submit-btn">
				<span style="color:none">确认添加</span>
			</button>
