...
<link rel="stylesheet" href="../../css/adminchangeandregist.css"
	media="all" />
...
<body class="childrenBody">
	<div
		style="font-size: 25px; margin: 30px 0 20px -10%; text-align: center;">添加学生</div>
	<div class="register" style="margin-left: 22%; width: 60%">
		<form method="post" action="addStudent.do">
			<div>
				<p class="admin-regist-lable">用户名</p>
				<input class="input-style" name="studentname"
					value="${student.studentname }" id="userName" type="text"
					placeholder="输入用户名">
				<!-- 提示信息 -->
				<p id="tishi" type="text" placeholder="提示信息"></p>
			</div>
			<div>
				<p class="admin-regist-lable">昵称</p>
				<input class="input-style" name="nickname"
					value="${student.nickname }" id="nickName" type="text"
					placeholder="昵称">
				<!-- 提示信息 -->
				<p id="tishi" type="text" placeholder="提示信息"></p>
			</div>
			<div>
				...
				<input class="input-style" name="password"
					value="${student.password }" id="passWord" type="password"
					placeholder="密码(8-16位数字和字母组成)">
				<!-- 提示信息 -->
				<p id="tishi" type="text" placeholder="提示信息"></p>
			</div>
			<div>
				<p class="admin-regist-lable">重复密码</p>
				<input class="input-style" name="newPassword"
					value="${newPassword }" id="newpassWord" type="password"
					placeholder="确认密码">
				<!-- 提示信息 -->
				<p id="tishi" type="text" placeholder="提示信息">${newPassword1 }</p>
			</div>
			<div>
				<p class="admin-regist-lable">电话</p>
				<input class="input-style" name="telephone"
					value="${student.telephone }" id="telephone" type="text"
					placeholder="手机号">
				<!-- 提示信息 -->
				<p id="tishi" type="text" placeholder="提示信息"></p>
			</div>
			<div>
				...
				<input class="input-style" name="email" value="${student.email }"
					id="email" type="text" placeholder="邮箱">
				<!-- 提示信息 -->
				<p id="tishi" type="text" placeholder="提示信息"></p>
			</div>
			<div class="shenfen" style="display: none">
				添加学生<input name="type" type="radio" value="1" checked="true">
				...
				function() {
					$.ajax({
						...
						success : function(data) {
							console.log(data);
							if (data == "true") {
								$('#email').next().html("该邮箱可用").css('color',
										'#10ea10');
							}
							if (data == "false1") {
